            ...
            <div class="p-8 mt-[80px]">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <button @click="showModal = true"
                        class="bg-[#383838] text-white px-6 py-2.5 rounded-lg font-bold hover:bg-[#383838] transition">
                        + Create New Class
                    </button>
                </div>
                ...
                <template x-teleport="body">
                    <div x-show="showModal"
                        ...
                        <div @click.away="showModal = false"
                            class="bg-white rounded-xl shadow-xl w-full max-w-4xl p-8 m-4">
                            ...
                            <form action="{{ route('admin.generate-code') }}" method="POST">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <button type="submit"
                                        class="w-full bg-[#383838] hover:bg-[#383838] text-white font-bold py-3 px-4 rounded-lg shadow transition uppercase tracking-widest text-sm">
                                        Save Session
                                    </button>
                                </div>
                            </form>
...
formatSurnameFirst(fullName) {
    if (!fullName) return '';
    if (fullName.includes(',')) return fullName; // Already formatted
    const parts = fullName.trim().split(/\s+/);
    if (parts.length <= 1) return fullName;
    
    const lastName = parts.pop(); // Take the last word as surname
...
get filteredAvailableStudents() {
    let list = this.allStudents.filter(s => {
        ...
        // Matches search criteria against both raw name, custom surname-first format, and student ID
            ...
            return this.sortOrder === 'asc' ? nameA.localeCompare(nameB) : nameB.localeCompare(nameA);
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <template x-for="session in filteredSessions" :key="session.id">
                                    <tr class="hover:bg-gray-50 transition-colors group">
                                        <td class="px-6 py-4">
                                            <span
                                                class="font-mono font-bold bg-gray-100 px-2 py-1 rounded text-sm group-hover:bg-[#383838] group-hover:text-white transition"
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <button @click="openStudents(session)"
                                                class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-gray-100 text-gray-700 hover:bg-[#383838] hover:text-white transition cursor-pointer">
                                ...
                                <form :action="'/admin/classroom/' + editingSession.id + '/edit'" method="POST">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="pt-4 flex gap-3">
                                            <button type="submit"
                                                class="flex-1 bg-[#383838] hover:bg-[#383838] text-white font-bold py-3 rounded-lg shadow transition uppercase tracking-widest text-sm">
                                                Update Session
                                            </button>
                    ...
                    <template x-teleport="body">
                        <div x-show="showStudentsModal"
                            ...
                            <div class="bg-white rounded-2xl p-8 shadow-2xl w-full max-w-4xl m-4 flex flex-col max-h-[90vh] transform transition-all"
                                ...
                                <div class="flex justify-between items-center mb-6">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Manage Enrollment for <span
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-black text-gray-400 uppercase mb-4 tracking-widest">
                                    ...
                                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                                        <div class="flex justify-between items-center mb-4">
                                            <h4 class="text-sm font-black text-gray-800 uppercase tracking-widest">Add
                                                Students</h4>
                                        ...
                                        <div class="space-y-3 mb-4">
                                            ...
                                            <div class="grid grid-cols-3 gap-2">
                                                <select x-model="studentFilterProgram"
                                                    class="text-[10px] border-gray-300 rounded-md p-1">
                                        ...
                                        <form @submit.prevent="enrollSelected()">
                                            ...
                                            <button type="submit" :disabled="selectedStudents.length === 0"
                                                :class="selectedStudents.length === 0 ? 'bg-gray-300 cursor-not-allowed' : 'bg-[#383838] hover:bg-gray-800'"
