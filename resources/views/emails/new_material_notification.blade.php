...
<head>
    ...
    <title>New Learning Material Published</title>
</head>
        ...
        <tr>
            <td style="padding: 40px 32px;">
                ...
                <p style="color: #4b5563; font-size: 14px; line-height: 1.6; font-weight: 500; margin: 0 0 24px 0;">
                   Hi, {{ $student->first_name }}! New learning materials have been uploaded for your class.
                </p>
                ...
                <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
                    ...
                    <span style="display: block; color: #9ca3af; font-size: 10px; font-weight: 800; text-transform: uppercase; margin-bottom: 2px;">Material Title</span>
                    <span style="display: block; color: #111827; font-size: 15px; font-weight: 700; margin-bottom: 12px;">{{ $material->title }}</span>
                    
                    <span style="display: block; color: #9ca3af; font-size: 10px; font-weight: 800; text-transform: uppercase; margin-bottom: 2px;">Resource Structural Type</span>
                    <span style="display: inline-block; background-color: #e5e7eb; color: #111827; font-size: 11px; font-weight: 800; text-transform: uppercase; padding: 4px 8px; border-radius: 6px;">
               ...
               <div style="background-color: #fff5f5; border: 1px solid #fee2e2; border-radius: 12px; padding: 18px; text-align: center;">
                    ...
                    <p style="color: #991b1b; font-size: 12px; line-height: 1.5; font-weight: 600; margin: 0;">
                        This learning material cannot be accessed via home networks, personal internet routers, or mobile devices. You are required to view this material exclusively on designated school laboratory during your officially scheduled class hours.
                    </p>
                </div>
            </td>
        </tr>
