            ...
            <form action="{{ route('professor.quizzes.store') }}" method="POST" class="space-y-8">
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-200">
                    <div class="flex justify-between items-center mb-8">
                        <div>
                            ...
                            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">Configure general exam settings</p>
                        </div>
                        <span class="px-4 py-2 bg-gray-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest"
                            x-text="questions.length + ' Questions Total'"></span>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="md:col-span-2">
                            <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Quiz Title</label>
                        ...
                        <div>
                            <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Time Limit (Minutes)</label>
                        ...
                        <div>
                            <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Assigned Lab Session</label>
                            <div class="p-4 bg-gray-100 rounded-2xl text-[#383838] font-black text-xs border border-gray-200 uppercase tracking-tight">
                        ...
                        <div>
                            <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Schedule Post</label>
                        ...
                        <div>
                            <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Quiz Deadline</label>
                ...
                <div class="space-y-6">
                    ...
                    <template x-for="(question, qIndex) in questions" :key="qIndex">
                        <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 transition-all hover:border-gray-900 group">

                            <div class="flex justify-between items-center mb-6">
                                <div class="flex items-center gap-4">
                                    <span class="w-8 h-8 rounded-full bg-gray-900 text-white flex items-center justify-center text-xs font-black" x-text="qIndex + 1"></span>
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                <div class="col-span-12 md:col-span-10">
                                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Question Text</label>
                                ...
                                <div class="col-span-12 md:col-span-2">
                                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-2">Points</label>
                            ...
                            <template x-if="question.type === 'true_false'">
                                <div class="mt-8 flex gap-4">
                                    <template x-for="(option, oIndex) in ['True', 'False']" :key="oIndex">
                                        <label class="flex-1 flex items-center justify-center p-5 bg-gray-50 rounded-2xl border-2 border-transparent cursor-pointer hover:border-black transition-all group-active:scale-95">
                                            <input type="radio" :name="'questions['+qIndex+'][correct_option]'"
                                                :value="option" required class="w-5 h-5 text-black focus:ring-2 focus:ring-gray-400 focus:border-gray-400  mr-4">
                                            <span class="font-black text-xs uppercase tracking-widest text-gray-700" x-text="option"></span>
                                            <input type="hidden" :name="'questions['+qIndex+'][options]['+oIndex+']'" :value="option">
                                        </label>
                                    </template>
                                </div>
                            </template>
                            ...
                            <template x-if="question.type === 'identification'">
                                <div class="mt-8">
                                    <label class="text-[10px] font-black text-gray-900 uppercase tracking-widest block mb-2">Expected Answer (Case Sensitive)</label>
                ...
                <div class="flex justify-between items-center py-10 border-t border-gray-200">
                    ...
                    <button type="submit" class="bg-gray-900 text-white px-10 py-4 rounded-2xl font-black uppercase text-xs tracking-widest hover:shadow-2xl hover:shadow-gray-400 transition-all active:scale-95">
