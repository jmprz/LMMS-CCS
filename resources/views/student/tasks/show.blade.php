        ...
        <div class="max-w-4xl mx-auto px-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-sm text-gray-600 mt-1">
                                {{ number_format(($submissionGrade->total_score / max(1, $submissionGrade->max_score)) * 100, 1) }}%
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative pt-1">
                        <div class="flex mb-2 items-center justify-between">
                            <span class="text-xs font-semibold inline-block text-gray-600">Score Progress</span>
                        </div>
                        <div class="overflow-hidden h-4 mb-4 text-xs flex rounded-full bg-gray-200">
                            <div style="width:{{ ($submissionGrade->total_score / max(1, $submissionGrade->max_score)) * 100 }}%" 
            ...
            @elseif($submission)
                ...
                <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
                    <i class="ri-time-line text-6xl text-amber-300 mb-4"></i>
                    <h3 class="text-2xl font-black text-gray-900 mb-2">Grading in Progress</h3>
                    <p class="text-gray-600">Your submission is being reviewed. Check back shortly.</p>
                    <p class="text-sm text-gray-400 mt-2">File: {{ $submission->original_filename }}</p>
                </div>
            @else
                <!-- No Submission -->
                <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
                    <i class="ri-file-list-line text-6xl text-gray-300 mb-4"></i>
                    <h3 class="text-2xl font-black text-gray-900 mb-2">Not Yet Submitted</h3>
                    <p class="text-gray-600">You have not submitted anything for this task.</p>
                </div>
            @endif
