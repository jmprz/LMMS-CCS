<nav x-data="{ open: false }" class="bg-white border-b border-gray-300 sticky top-0 z-50">
    <div class="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 md:h-20">
            ...
            <div class="flex items-center">
                <div class="flex items-center space-x-2 md:space-x-3 bg-gray-50 px-3 py-1.5 md:px-4 md:py-2 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <div class="flex flex-col text-right">
                        <span id="nav-live-clock" class="font-black text-xs md:text-sm text-gray-800 tracking-tight leading-none">
                            00:00:00 AM
                        </span>
                        <span id="nav-live-date" class="hidden sm:block font-bold text-[8px] md:text-[10px] text-gray-400 uppercase tracking-wider mt-0.5 md:mt-1 leading-none">
                            Loading Date...
                        </span>
                    </div>
                </div>
