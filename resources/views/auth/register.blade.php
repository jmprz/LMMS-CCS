    ...
    <div class="min-h-screen flex flex-col md:flex-row bg-white text-gray-900">
        <div class="hidden md:flex md:w-2/5 bg-[#383838] items-center justify-center p-12 relative">
            <div class="text-white text-center">
                ...
                <h1 class="text-3xl font-bold uppercase tracking-tight mb-4">Learning and Monitoring Management System
                </h1>
        ...
        <div class="flex-1 flex items-center justify-center p-8 bg-gray-100 overflow-y-auto">
            <div class="w-full max-w-2xl">
                ...
                <form method="POST" action="{{ route('register') }}"
                    x-data="{ role: 'student', showPass: false, showConfirm: false }" class="space-y-4">
                    @csrf
                                ...
                                <template x-if="!showPass">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M2.036 12.322a1.012 1.012 0 010-.644C3.67 8.5 7.652 5 12 5c4.348 0 8.331 3.5 9.964 6.678.14.272.14.578 0 .85C20.33 15.5 16.348 19 12 19c-4.348 0-8.331-3.5-9.964-6.678z" />
                                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="pt-4 space-y-4">
                        <button type="submit"
                            class="w-full bg-[#383838] text-white font-bold py-3.5 rounded-xl hover:bg-black transition-all shadow-lg active:scale-[0.99] uppercase">
                            Register Account
                        </button>
                        <p class="text-center text-gray-600 text-sm">
                            Already registered? <a href="{{ route('login') }}"
                                class="font-bold text-[#383838] hover:underline">Sign in instead</a>
                        </p>
                    </div>
                </form>
            </div>
