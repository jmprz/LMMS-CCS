    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 bg-gray-100">
        <div class="w-full max-w-md bg-white rounded-xl shadow-md p-8">
            ...
            <div class="mb-6 text-left">
                <h2 class="text-4xl font-black text-gray-900 mb-2">Verify Code</h2>
                <p class="text-gray-600 text-md">Step 2: Enter your security token</p>
            </div>

            <p class="text-sm font-medium text-gray-500 mb-6">
                We have sent a 6-digit confirmation code to your email. Please type it below to authorize your password recovery.
            </p>
