    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-6 bg-gray-100">
        <div class="w-full max-w-md bg-white rounded-xl shadow-md p-8">
            ...
            <div class="mb-6 text-left">
                <h2 class="text-4xl font-black text-gray-900 mb-2">Account Activation</h2>
                <p class="text-gray-600 text-md">Step 1: Initialize your institutional profile gateway</p>
            </div>
            ...
            <form method="POST" action="{{ route('activation.send_otp') }}" class="space-y-5">
                ...
                <div>
                    <x-input-label for="email" value="Active Email Address" class="font-bold text-xs uppercase tracking-wider text-gray-600 mb-1.5" />
